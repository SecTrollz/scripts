...
<style>
:root {
  /* palette sampled directly from the login hand/hologram photo (login-photo) */
  --bg-base: #011236;
  --bg-elevated: #01245B;
  --bg-inset: #120612;
  --border-subtle: #31233B;
  --border-strong: #48487B;
  --text-primary: #CAEFFB;
...
@media (max-width: 768px) {
  .login-photo { background-position: 56% 42%; }
}
.login-card {
  position: relative;
  z-index: 1;
...
.login-logo {
  ...
  font-weight: 700;
  font-size: 26px;
  box-shadow: 0 4px 16px rgba(84,180,236,0.35);
}
.login-title {
  font-size: 1.6rem;
  font-weight: 600;
